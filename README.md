...
git checkout v1.20-support-unicode

# 编译前端
npm.cmd install --no-save
npx.cmd webpack
...
原中文README文档：[README_ZH.md](old/README_ZH.md)
